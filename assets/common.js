...
function buildSkins() {
  const list = [{
    ...
    head: "#eafcff", body: ["#35e7ff", "#8b5cf6"], glow: "rgba(53,231,255,0.6)", power: null
  }];
  let idx = 0;
...
function buildBackgrounds() {
  const list = [{ id: "default", name: "Dusk Horizon", price: 0, tier: "Free", type: "gradient", stops: ["#05040a", "#130a24", "#20122e"], power: null }];
  let idx = 0;
